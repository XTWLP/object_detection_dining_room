...
PyObject *CALL_FUNCTION_WITH_ARGS25(PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
     CHECK_OBJECTS(args, 25); 
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 25 == function->m_args_positional_count){
            for (Py_ssize_t i = 0; i < 25; i++) {
                Py_INCREF(args[i]);
            }
            result = function->m_c_code(function,  (PyObject **)args );
        } else if (function->m_args_simple && 25 + function->m_defaults_given == function->m_args_positional_count) {
            NUITKA_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_positional_count);

            memcpy(python_pars, args, 25 * sizeof(PyObject *));
            memcpy(python_pars + 25, &PyTuple_GET_ITEM(function->m_defaults, 0), function->m_defaults_given * sizeof(PyObject *));
            ...
            result = Nuitka_CallFunctionPosArgs(function, args, 25);
        }
        ...
        if (method->m_object == NULL) {
            ...
            return Nuitka_CallFunctionPosArgs(method->m_function, args, 25);
        } else {
            if (unlikely(Py_EnterRecursiveCall((char *)" while calling a Python object"))) {
                return NULL;
            }
            ...
            if (function->m_args_simple && 25 + 1 == function->m_args_positional_count) {
                PyObject *python_pars[25 + 1];
                ...
                result = function->m_c_code(function, python_pars);
            } else if (function->m_args_simple && 25 + 1 + function->m_defaults_given == function->m_args_positional_count) {
                NUITKA_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_positional_count);

                python_pars[0] = method->m_object;
                Py_INCREF(method->m_object);

                memcpy(python_pars+1, args, 25 * sizeof(PyObject *));
                memcpy(python_pars+1 + 25, &PyTuple_GET_ITEM(function->m_defaults, 0), function->m_defaults_given * sizeof(PyObject *));
                ...
                result = Nuitka_CallMethodFunctionPosArgs(function, method->m_object, args, 25);
            }
        ...
        if (unlikely(flags & METH_NOARGS)) {
            SET_CURRENT_EXCEPTION_TYPE0_FORMAT1(
                PyExc_TypeError,
                "%s() takes no arguments (25 given)",
                ((PyCFunctionObject *)called)->m_ml->ml_name
            );
            return NULL;
        } else if (unlikely(flags & METH_O)) {
            SET_CURRENT_EXCEPTION_TYPE0_FORMAT1(PyExc_TypeError,
                "%s() takes exactly one argument (25 given)",
                 ((PyCFunctionObject *)called)->m_ml->ml_name
            );
            return NULL;
        } else if (flags & METH_VARARGS) {
...
#if PYTHON_VERSION < 0x360
            PyObject *pos_args = MAKE_TUPLE(args, 25);
            if (flags & METH_KEYWORDS) {
                result = (*(PyCFunctionWithKeywords)method)(self, pos_args, NULL);
            } else {
                result = (*method)(self, pos_args);
...
#if PYTHON_VERSION < 0x370
                result = (*(_PyCFunctionFast)method)(self, (PyObject **)args, 25, NULL);
#else
            PyObject *pos_args = MAKE_TUPLE(args, 25);
                result = (*(_PyCFunctionFast)method)(self, &pos_args, 25);
            Py_DECREF(pos_args);
#endif
            } else {
            PyObject *pos_args = MAKE_TUPLE(args, 25);
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs((struct Nuitka_FunctionObject const *)init_method, obj, args, 25);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS25(init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
        ...
        if (likely(func != NULL)) {
            PyObject *result = func(called, args, 25, NULL);
...
PyObject *CALL_FUNCTION_WITH_POSARGS26(PyObject *called, PyObject *pos_args) {
    assert(PyTuple_CheckExact(pos_args));
    assert(PyTuple_GET_SIZE(pos_args) == 26);
    PyObject *const *args = &PyTuple_GET_ITEM(pos_args, 0);
    CHECK_OBJECT(called);
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        if (is_compiled_function) {
                            ...
                            result = CALL_FUNCTION_WITH_POSARGS26(init_method, pos_args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_POSARGS28(PyObject *called, PyObject *pos_args) {
    assert(PyTuple_CheckExact(pos_args));
    assert(PyTuple_GET_SIZE(pos_args) == 28);
    PyObject *const *args = &PyTuple_GET_ITEM(pos_args, 0);
    CHECK_OBJECT(called);
     CHECK_OBJECTS(args, 28); 
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 28 == function->m_args_positional_count){
            for (Py_ssize_t i = 0; i < 28; i++) {
                Py_INCREF(args[i]);
            }
            result = function->m_c_code(function,  (PyObject **)args );
        } else if (function->m_args_simple && 28 + function->m_defaults_given == function->m_args_positional_count) {
            NUITKA_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_positional_count);

            memcpy(python_pars, args, 28 * sizeof(PyObject *));
            memcpy(python_pars + 28, &PyTuple_GET_ITEM(function->m_defaults, 0), function->m_defaults_given * sizeof(PyObject *));
            ...
            result = Nuitka_CallFunctionPosArgs(function, args, 28);
        }
        ...
        if (method->m_object == NULL) {
            ...
            return Nuitka_CallFunctionPosArgs(method->m_function, args, 28);
        } else {
            if (unlikely(Py_EnterRecursiveCall((char *)" while calling a Python object"))) {
                return NULL;
            }
            ...
            if (function->m_args_simple && 28 + 1 == function->m_args_positional_count) {
                PyObject *python_pars[28 + 1];
                ...
                result = function->m_c_code(function, python_pars);
            } else if (function->m_args_simple && 28 + 1 + function->m_defaults_given == function->m_args_positional_count) {
                NUITKA_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_positional_count);

                python_pars[0] = method->m_object;
                Py_INCREF(method->m_object);

                memcpy(python_pars+1, args, 28 * sizeof(PyObject *));
                memcpy(python_pars+1 + 28, &PyTuple_GET_ITEM(function->m_defaults, 0), function->m_defaults_given * sizeof(PyObject *));
                ...
                result = Nuitka_CallMethodFunctionPosArgs(function, method->m_object, args, 28);
            }
        ...
        if (unlikely(flags & METH_NOARGS)) {
            SET_CURRENT_EXCEPTION_TYPE0_FORMAT1(
                PyExc_TypeError,
                "%s() takes no arguments (28 given)",
                ((PyCFunctionObject *)called)->m_ml->ml_name
            );
            return NULL;
        } else if (unlikely(flags & METH_O)) {
            SET_CURRENT_EXCEPTION_TYPE0_FORMAT1(PyExc_TypeError,
                "%s() takes exactly one argument (28 given)",
                 ((PyCFunctionObject *)called)->m_ml->ml_name
            );
            return NULL;
        } else if (flags & METH_VARARGS) {
...
#if PYTHON_VERSION < 0x370
                result = (*(_PyCFunctionFast)method)(self, (PyObject **)args, 28, NULL);
#else
                result = (*(_PyCFunctionFast)method)(self, &pos_args, 28);
#endif
            } else {
                result = (*method)(self, pos_args);
            }
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs((struct Nuitka_FunctionObject const *)init_method, obj, args, 28);
                        } else {
                            result = CALL_FUNCTION_WITH_POSARGS28(init_method, pos_args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
        ...
        if (likely(func != NULL)) {
            PyObject *result = func(called, args, 28, NULL);
...
PyObject *CALL_METHOD_WITH_ARGS20(PyObject *source, PyObject *attr_name, PyObject *const *args) {
    CHECK_OBJECT(source);
    CHECK_OBJECT(attr_name);
        ...
        if (descr != NULL) {
            ...
            if (NuitkaType_HasFeatureClass(Py_TYPE(descr))) {
                ...
                if (func != NULL && PyDescr_IsData(descr)) {
                    ...
                    PyObject *result = CALL_FUNCTION_WITH_ARGS20(called_object, args)
;
                    Py_DECREF(called_object);
                    return result;
                }
...
;
        ...
        if (descr != NULL) {
            ...
            PyObject *result = CALL_FUNCTION_WITH_ARGS20(descr, args)
;
            Py_DECREF(descr);
            return result;
        }
...
PyObject *CALL_METHOD_WITH_ARGS21(PyObject *source, PyObject *attr_name, PyObject *const *args) {
    CHECK_OBJECT(source);
    CHECK_OBJECT(attr_name);
        ...
        if (descr != NULL) {
            ...
            if (NuitkaType_HasFeatureClass(Py_TYPE(descr))) {
                ...
                if (func != NULL && PyDescr_IsData(descr)) {
                    ...
                    PyObject *result = CALL_FUNCTION_WITH_ARGS21(called_object, args)
;
                    Py_DECREF(called_object);
                    return result;
                }
...
;
        ...
        if (descr != NULL) {
            ...
            PyObject *result = CALL_FUNCTION_WITH_ARGS21(descr, args)
;
            Py_DECREF(descr);
            return result;
        }
        ...
        // so we need not release it in this branch.
        if (called_object != NULL) {
            return CALL_FUNCTION_WITH_ARGS21(called_object, args)
;
        }
        ...
        if (called_object != NULL) {
            ...
            if (descr_get == Nuitka_Function_Type.tp_descr_get) {
                ...
                PyObject *result = CALL_FUNCTION_WITH_ARGS21(method, args)
;
                Py_DECREF(method);
                return result;
            } else {
