...
static PyCodeObject *codeobj_fcd4fcfcf4761aff89bd15723c2d8b30;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[12]); CHECK_OBJECT(module_filename_obj);
    codeobj_fcd4fcfcf4761aff89bd15723c2d8b30 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[13], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_fcd4fcfcf4761aff89bd15723c2d8b30;
    ...
    // Frame without reuse.
    frame_fcd4fcfcf4761aff89bd15723c2d8b30 = MAKE_MODULE_FRAME(codeobj_fcd4fcfcf4761aff89bd15723c2d8b30, module_chardet$compat);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_fcd4fcfcf4761aff89bd15723c2d8b30);
    assert(Py_REFCNT(frame_fcd4fcfcf4761aff89bd15723c2d8b30) == 2);
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_fcd4fcfcf4761aff89bd15723c2d8b30);
#endif
    popFrameStack();

    assertFrameObject(frame_fcd4fcfcf4761aff89bd15723c2d8b30);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_fcd4fcfcf4761aff89bd15723c2d8b30, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_fcd4fcfcf4761aff89bd15723c2d8b30->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_fcd4fcfcf4761aff89bd15723c2d8b30, exception_lineno);
    }
