...
static PyCodeObject *codeobj_d0b9762755d90e2b190d56a19193db3e;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[40]); CHECK_OBJECT(module_filename_obj);
    codeobj_d0b9762755d90e2b190d56a19193db3e = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[41], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_d0b9762755d90e2b190d56a19193db3e;
    ...
    // Frame without reuse.
    frame_d0b9762755d90e2b190d56a19193db3e = MAKE_MODULE_FRAME(codeobj_d0b9762755d90e2b190d56a19193db3e, module_chardet$langcyrillicmodel);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_d0b9762755d90e2b190d56a19193db3e);
    assert(Py_REFCNT(frame_d0b9762755d90e2b190d56a19193db3e) == 2);
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_d0b9762755d90e2b190d56a19193db3e);
#endif
    popFrameStack();

    assertFrameObject(frame_d0b9762755d90e2b190d56a19193db3e);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_d0b9762755d90e2b190d56a19193db3e, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_d0b9762755d90e2b190d56a19193db3e->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_d0b9762755d90e2b190d56a19193db3e, exception_lineno);
    }
