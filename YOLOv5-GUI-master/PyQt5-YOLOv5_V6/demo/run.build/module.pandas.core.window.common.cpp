...
static PyObject *impl_pandas$core$window$common$$$function__1_flex_binary_moment(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_no_19:;
    {
...

        {
            ...
            tmp_ass_subvalue_4 = impl___main__$$$function__2_complex_call_helper_star_list(dir_call_args);
        }
    ...
    branch_no_4:;
    {
...

        {
...

            {
                ...
                tmp_dictset38_value_1 = impl___main__$$$function__2_complex_call_helper_star_list(dir_call_args);
            }
