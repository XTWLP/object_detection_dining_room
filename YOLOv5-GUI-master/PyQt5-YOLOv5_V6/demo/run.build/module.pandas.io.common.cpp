...
static PyObject *impl_pandas$io$common$$$function__10__get_filepath_or_buffer(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_called_instance_3 = impl___main__$$$function__12_complex_call_helper_pos_keywords_star_dict(dir_call_args);
        }
    ...
    branch_end_14:;
    {
...

        {
            ...
            tmp_called_instance_4 = impl___main__$$$function__12_complex_call_helper_pos_keywords_star_dict(dir_call_args);
        }
...
static PyObject *impl_pandas$io$common$$$function__14_get_handle(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_no_4:;
    {
...

        {
            ...
            tmp_assign_source_20 = impl___main__$$$function__16_complex_call_helper_keywords_star_dict(dir_call_args);
        }
