...
static PyObject *impl_pandas$plotting$_matplotlib$misc$$$function__5_bootstrap_plot(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
...

        {
            ...
            tmp_call_result_15 = impl___main__$$$function__7_complex_call_helper_pos_star_dict(dir_call_args);
        }
        if (tmp_call_result_15 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
...

        {
            ...
            tmp_call_result_18 = impl___main__$$$function__7_complex_call_helper_pos_star_dict(dir_call_args);
        }
