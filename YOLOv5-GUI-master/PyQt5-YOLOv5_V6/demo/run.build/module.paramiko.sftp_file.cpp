...
static PyCodeObject *codeobj_1b647506b26ca343922c01496de402a8;
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_1b647506b26ca343922c01496de402a8 = MAKE_CODEOBJECT(module_filename_obj, 113, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[218], mod_consts[220], NULL, 1, 0, 0);
...
static PyObject *impl_paramiko$sftp_file$$$function__5__data_in_prefetch_requests(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    PyTracebackObject *exception_tb = NULL;
    NUITKA_MAY_BE_UNUSED int exception_lineno = 0;
    struct Nuitka_FrameObject *frame_1b647506b26ca343922c01496de402a8_2;
    ...
    PyTracebackObject *exception_keeper_tb_1;
    NUITKA_MAY_BE_UNUSED int exception_keeper_lineno_1;
    static struct Nuitka_FrameObject *cache_frame_1b647506b26ca343922c01496de402a8_2 = NULL;
    PyObject *exception_keeper_type_2;
    PyObject *exception_keeper_value_2;
    PyTracebackObject *exception_keeper_tb_2;
    NUITKA_MAY_BE_UNUSED int exception_keeper_lineno_2;
    ...
    // Framed code:
    {
        ...
        if (isFrameUnusable(cache_frame_1b647506b26ca343922c01496de402a8_2)) {
            Py_XDECREF(cache_frame_1b647506b26ca343922c01496de402a8_2);

#if _DEBUG_REFCOUNTS
            if (cache_frame_1b647506b26ca343922c01496de402a8_2 == NULL) {
                count_active_frame_cache_instances += 1;
            } else {
                count_released_frame_cache_instances += 1;
            }
            count_allocated_frame_cache_instances += 1;
#endif
            cache_frame_1b647506b26ca343922c01496de402a8_2 = MAKE_FUNCTION_FRAME(codeobj_1b647506b26ca343922c01496de402a8, module_paramiko$sftp_file, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
        } else {
            count_hit_frame_cache_instances += 1;
#endif
        }
        assert(cache_frame_1b647506b26ca343922c01496de402a8_2->m_type_description == NULL);
        frame_1b647506b26ca343922c01496de402a8_2 = cache_frame_1b647506b26ca343922c01496de402a8_2;

        // Push the new frame as the currently active one.
        pushFrameStack(frame_1b647506b26ca343922c01496de402a8_2);

        // Mark the frame object as in use, ref count 1 will be up for reuse.
        assert(Py_REFCNT(frame_1b647506b26ca343922c01496de402a8_2) == 2); // Frame stack
...
#if 0
        RESTORE_FRAME_EXCEPTION(frame_1b647506b26ca343922c01496de402a8_2);
#endif
        ...
        if (exception_tb == NULL) {
            exception_tb = MAKE_TRACEBACK(frame_1b647506b26ca343922c01496de402a8_2, exception_lineno);
        } else if (exception_tb->tb_frame != &frame_1b647506b26ca343922c01496de402a8_2->m_frame) {
            exception_tb = ADD_TRACEBACK(exception_tb, frame_1b647506b26ca343922c01496de402a8_2, exception_lineno);
        }

        // Attaches locals to frame if any.
        Nuitka_Frame_AttachLocals(
            frame_1b647506b26ca343922c01496de402a8_2,
            type_description_2,
            outline_0_var_x,
            par_offset
        );
        ...
        // Release cached frame if used for exception.
        if (frame_1b647506b26ca343922c01496de402a8_2 == cache_frame_1b647506b26ca343922c01496de402a8_2) {
#if _DEBUG_REFCOUNTS
            count_active_frame_cache_instances -= 1;
            count_released_frame_cache_instances += 1;
#endif

            Py_DECREF(cache_frame_1b647506b26ca343922c01496de402a8_2);
            cache_frame_1b647506b26ca343922c01496de402a8_2 = NULL;
        }

        assertFrameObject(frame_1b647506b26ca343922c01496de402a8_2);
...
static PyObject *impl_paramiko$sftp_file$$$function__25__start_prefetch(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
        ...
        frame_317d798bdc0b2ccffc241013dc7723e4->m_frame.f_lineno = 530;
...
// Mark the execution in the "__spec__" value.
    ...
    Py_INCREF(module_paramiko$sftp_file);
