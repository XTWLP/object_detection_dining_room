...
static PyObject *impl_torchvision$models$detection$ssdlite$$$function__10__mobilenet_extractor(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Framed code:
    {
...

        {
            ...
            tmp_expression_value_1 = impl___main__$$$function__16_complex_call_helper_keywords_star_dict(dir_call_args);
        }
        if (tmp_expression_value_1 == NULL) {
            assert(ERROR_OCCURRED());
...
static PyObject *impl_torchvision$models$detection$ssdlite$$$function__11_ssdlite320_mobilenet_v3_large(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    }
    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_dircall_arg1_2};
            tmp_assign_source_14 = impl___main__$$$function__17__unpack_dict(dir_call_args);
        }
        if (tmp_assign_source_14 == NULL) {
            assert(ERROR_OCCURRED());
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        UPDATE_STRING_DICT1(moduledict_torchvision$models$detection$ssdlite, (Nuitka_StringObject *)mod_consts[2], tmp_assign_source_25);
    }
    {
        ...
        UPDATE_STRING_DICT1(moduledict_torchvision$models$detection$ssdlite, (Nuitka_StringObject *)mod_consts[97], tmp_assign_source_26);
    }
    {
