...
static PyCodeObject *codeobj_133feb45919b31fd0546bbc475d7058f;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[210]); CHECK_OBJECT(module_filename_obj);
    codeobj_133feb45919b31fd0546bbc475d7058f = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[211], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_133feb45919b31fd0546bbc475d7058f;
    ...
    // Frame without reuse.
    frame_133feb45919b31fd0546bbc475d7058f = MAKE_MODULE_FRAME(codeobj_133feb45919b31fd0546bbc475d7058f, module_xlwt$ExcelMagic);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_133feb45919b31fd0546bbc475d7058f);
    assert(Py_REFCNT(frame_133feb45919b31fd0546bbc475d7058f) == 2);
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_133feb45919b31fd0546bbc475d7058f);
#endif
    popFrameStack();

    assertFrameObject(frame_133feb45919b31fd0546bbc475d7058f);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_133feb45919b31fd0546bbc475d7058f, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_133feb45919b31fd0546bbc475d7058f->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_133feb45919b31fd0546bbc475d7058f, exception_lineno);
    }
    ...
    frame_no_exception_1:;
    {
        ...
        tmp_assign_source_105 = PyDict_Copy(mod_consts[208]);
